...
El disseny, la redacció i presentació del projecte amb l'objectiu d'optar a la vacant de l'especialitat de Dibuix[^concurs-merits] a l'Institut Obert de Catalunya (IOC) és un fet que convida necessàriament a una reflexió personal sobre el recorregut realitzat fins ara, així com els nombrosos reptes que es derivin de la voluntat de continuar a l'IOC quatre anys més (2022-2026).

[^concurs-merits]: RESOLUCIÓ EDU/172/2022, de 31 de gener, per la qual es convoca concurs de mèrits per a la provisió de llocs de treball vacants, en comissió de serveis, a l'Institut Obert de Catalunya.
...
En primer lloc, he estat responsable del disseny i metodologia de les aules (recursos i activitats) de les següents matèries de batxillerat de la modalitat d'arts:
...
En segon lloc, la col·laboració de projectes transversals de centre o específics d'altres estudis de l'IOC, han significat personalment una de les estratègies més genuines en l'apoderament del centre de treball com a propi. En el context de la complexitat d'un centre com l'IOC, ho estimo com a pas necessari per trencar les sinèrgies dels diferentes estudis i consolidar una lectura més de conjunt i, en conseqüència, incorporar, com a retorn de l'aprenentatge, l'experiència assolida a la docència:
...
* El març del 2020 vaig compartir amb la direcció acadèmica de Batxillerat una **proposta de projecte de *materials***[^projecte_materials] per als estudis de Batxillerat on es recollia, en primer lloc, una anàlisi de l'estat actual de les diferents estratègies de creació i publicació de recursos d'aprenentatge i, finalment, orientacions generals per a la concreció d'un nou marc de l'edició i publicació dels materials als estudis de batxillerat.
...
L'actual proposta de projecte comparteix la mateixa motivació i impuls: mirar d'aportar una resposta a aquelles qüestions o reptes associats a les implicacions d'estudiar a Internet en el context sociocultural actual. La següent concreció de **tres eixos d'actuacions** m'ajudaran, per una banda, a identificar els diferents i possibles condicionants d'*estudiar davant d'una pantalla*[^Studying-on-a-screen] i, d'altra banda, perfilar quins són els objectius que haurien de pautar l'activitat docent a l'IOC:
