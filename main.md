...
No obstant, aquesta línia de disseny d'activitats basades en un elevat grau de **personalització del feedback**, no està exenta de dificultats si considerem aquelles qüestions enumerades a la secció de les **singularitats dels estudis de Batxillerat a l'IOC** d'aquest mateix document: un excés de d'inversió de temps inassumible, la diversitat del perfil d'estudiant, la participació de col·laboradors a l'aula a causa del nombre elevat d'estudiants matriculats o, simplement, la pròpia organització del calendari dels estudis a l'IOC,  poden representar un obstacle en la realització o, fins i tot, desnaturalització de les activitats proposades.

En un altre àmbit, el **seguiment** de l'estudiant en relació amb la realitazació i avaluació de les activitats de l'aula no està exclosa d'altres dificultats com, per exemple, el *grau de retorn del feedback*. És a dir, quines estratègies tenim a l'abast en un EVA per verificar i validar que els estudiants fan ús actiu de l'avaluació en l'assoliment de les competències de la matèria?
