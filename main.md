...
**LAIA**: Creus que hauria d'incloure els tres anys al Departament d'Educació com a tècnic docent? **Resposta Laia**: Jo m'ho petaria tot i ho deixaria com a referències. Començaria directament per la Proposta de projecte. Pots fer una prèvia: "Havent pres part activa en diversos projectes transversals de l'IOC entre els anys tal i tal (aquí notes les que calgui amb els projectes referenciats", exposo tot seguit una parell de consideracions prèvies sobre **l'IOC i la transformació digital de l'educació** i **la singularitat de la modalitat d'Arts del Batxillerat a l'IOC**. Tot seguit obres subseccions i mira de resumir al màxim les teves reflexions (m'encanta la de l'hospitalitat del coreà de nom impronunciable) i, sobretot, de cloure-les amb un apunt molt clar del que en penses. Per exemple penso que no acabes d'enunicar clarament quina és la teva aposta per les actuacions síncrones. 
