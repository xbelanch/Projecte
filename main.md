...
En segon lloc, la col·laboració en projectes transversals de centre o específics d'altres estudis de l'IOC ha significat per a mi una de les estratègies més genuïnes de compromís amb el centre de treball. En el context de la complexitat d'un centre com l'IOC, entenc aquest compromís com un pas necessari per trencar les sinergies dels diferentes estudis i consolidar una lectura més de conjunt i, en conseqüència, incorporar noves maneres consensudaes de fer com a retorn de l'aprenentatge de l'experiència assolida a la docència:
...
* Al 2015 vaig definir el disseny de cobertes dels materials d'estudi de la **Formació Pedagògica i Didàctica** (FPD)[^fpd] i em vaig encarregar de la realiutzació del recurs *Repositori audiovisual d’educació de la Formació pedagògica i didàctica per exercir de professor*[^fpdvideos].
* He pres part en diferents **equips de millora dels estudis de Batxillerat**, en particular en el disseny i creació de documents marc del professorat responsable i col·laborador.
...
L'actual proposta de projecte comparteix la mateixa motivació i impuls: mirar d'aportar una resposta a aquelles qüestions o reptes associats a les implicacions d'estudiar a Internet en el context sociocultural actual. La següent concreció de **tres eixos d'actuacions** ajudaran, per una banda, a identificar els diferents i possibles condicionants d'*estudiar davant d'una pantalla*[^Studying-on-a-screen] i, d'altra banda, perfilar quins són els objectius que haurien de pautar l'activitat docent a l'IOC:
...
Si bé el PEC de l'IOC afirma com a procés *evolutiu* el pas del material PDF a "format Moodle", és a dir, en *Llibre de Moodle* o *Lliçons* (amb la integració lògica de recursos audiovisuals com diapositives, vídeos o interaccions H5P), el cert és que aquesta mirada situa l'EVA de l'IOC com a espai estratègic d'edició i publicació dels materials i recursos d'estudi de les aules sense cap qüestionament o reflexió prèvia de com haurien de ser els materials d'estudi en l'actual context d'estudiar a Internet:
...
En aquesta direcció, una part significativa del disseny dels recursos d'estudi de les aules que imparteixo a l'IOC estan inspirades en projectes públics com [Smart History](https://smarthistory.org/),  [Khan Academy](https://www.khanacademy.org/), projectes personals com [The Art Assignment](https://www.youtube.com/user/theartassignment), però també totes aquelles propostes d'actualitat associades a entitats culturals del territori  (MACBA, CCCB, MNAC, Fundació Miró...) com internacionals (Tate Modern, MET, MoMA...). Totes elles, en conjunt, serveixen d'ajuda no únicament en el desenvolupament dels materials d'estudi sinó també en l'oportunitat de definir la presentació i estructura dels materials d'estudi com a **curació de recursos** que han de satisfer, per una banda, l'exigència del currículum com, sobretot, oferir els estudiants uns mitjans per a l'aprenentatge de qualitat i d'actualitat.

La **curació de recursos** ha de combinar els de creació pròpia amb aquells recursos de tercers que gaudeixen de llicències que permetin el seu ús, adaptació i publicació. Sóc del parer de la idea de **reciclatge** dels recursos, especialment aquells que, pel seu interès, idoneïtat i factura permetem que els estudiants accedeixin a una tipus d'informació que, a més d'encaixar en el relat de la proposta d'EA, amplien la seva mirada o referents.

Finalment, la **curació de recursos** dona protagonisme en com ha de ser el disseny seqüencial dels materials d'estudi en particular en l'accent de la narrativa del conjunt de la seqüència (el relat o *storytelling*). Crec que aquesta estratègia pot ajudar a temperar moltes de les dificultats que troben els estudiants davant del repte d'estudiar *a distància*.
